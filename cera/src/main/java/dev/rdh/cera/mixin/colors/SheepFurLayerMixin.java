...
public class SheepFurLayerMixin {
    @WrapOperation(method = "render(Lnet/minecraft/entity/living/mob/passive/animal/SheepEntity;FFFFFFF)V", at = @At(value = "INVOKE", target = "Lnet/minecraft/entity/living/mob/passive/animal/SheepEntity;getColorRgb(Lnet/minecraft/item/DyeColor;)[F"))
