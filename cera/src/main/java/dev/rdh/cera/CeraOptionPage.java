    ...
    static OptionPage create() {
        OptionGroup quality = OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, Cera.CONFIG_STORAGE)
                        ...
                        .setControl(TickBoxControl::new)
                        .setBinding((config, value) -> config.customPanorama = value, config -> config.customPanorama)
                        .setFlags(OptionFlag.REQUIRES_ASSET_RELOAD)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, Cera.CONFIG_STORAGE)
                        .setId(id("custom_loading_screens"))
                        .setControl(TickBoxControl::new)
                        .setBinding((config, value) -> config.customLoadingScreens = value, config -> config.customLoadingScreens)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, Cera.CONFIG_STORAGE)
