...
public final class EntityShadowBatch {
    ...
    private static GlProgram<ShadowShader> createProgram() {
        List<GlShader> shaders = List.of(
                ShaderLoader.loadShader(ShaderType.VERTEX, "celeritas:entity_shadow.vert", ShaderConstants.EMPTY),
                ShaderLoader.loadShader(ShaderType.FRAGMENT, "celeritas:entity_shadow.frag", ShaderConstants.EMPTY));
        try {
            GlProgram.Builder builder = GlProgram.builder("celeritas:entity_shadow");
