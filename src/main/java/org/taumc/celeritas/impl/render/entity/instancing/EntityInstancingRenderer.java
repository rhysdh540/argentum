...
public final class EntityInstancingRenderer {
    ...
    public static void beginFrame() {
        if (!Celeritas.CONFIG.entityInstancing) {
    ...
    private static GlProgram<EntityShader> createProgram() {
        ...
        List<GlShader> shaders = List.of(
                ShaderLoader.loadShader(ShaderType.VERTEX, "celeritas:entity_instancing.vert", constants),
                ShaderLoader.loadShader(ShaderType.FRAGMENT, "celeritas:entity_instancing.frag", constants));
        try {
            GlProgram.Builder builder = GlProgram.builder("celeritas:entity_instancing");
